...
function _ajax() {
  ...
  $.ajax({
    type: "GET",
    url: "http://127.0.0.1:8000/api/dataJalur",
    dataType: "json",
    async: false,
...
const headCells = [
  ...
  { id: "Lahir", numeric: true, disablePadding: false, label: "Lahir" },
];
...
const mapRedux = (store) => {
  return {
    data_J: store.data_jalur,
  };
};
export default connect(mapRedux)(EnhancedTable);
